...
var file_smallbiznis_transaction_v1_transaction_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x22, 0x8c, 0x02, 0x0a, 0x12, 0x43, 0x72, 0x65,
	...
	0x72, 0x49, 0x64, 0x12, 0x33, 0x0a, 0x13, 0x73, 0x68, 0x69, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x5f,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x11, 0x73, 0x68, 0x69, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x41,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x49, 0x64, 0x12, 0x46, 0x0a, 0x0b, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e,
	0x73, 0x6d, 0x61, 0x6c, 0x6c, 0x62, 0x69, 0x7a, 0x6e, 0x69, 0x73, 0x2e, 0x74, 0x72, 0x61, 0x6e,
	...
	0x74, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x22, 0x2c, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x4f, 0x72,
...
var file_smallbiznis_transaction_v1_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_smallbiznis_transaction_v1_transaction_proto_goTypes = []interface{}{
	...
	(*CreateOrderRequest)(nil),    // 3: smallbiznis.transaction.v1.CreateOrderRequest
	(*GetOrderRequest)(nil),       // 4: smallbiznis.transaction.v1.GetOrderRequest
...
var file_smallbiznis_transaction_v1_transaction_proto_depIdxs = []int32{
	...
	5, // 1: smallbiznis.transaction.v1.ListOrderResponse.data:type_name -> smallbiznis.transaction.v1.Order
	6, // 2: smallbiznis.transaction.v1.CreateOrderRequest.order_items:type_name -> smallbiznis.transaction.v1.OrderItem
	1, // 3: smallbiznis.transaction.v1.TransactionService.ListOrder:input_type -> smallbiznis.transaction.v1.ListOrderRequest
	4, // 4: smallbiznis.transaction.v1.TransactionService.GetOrder:input_type -> smallbiznis.transaction.v1.GetOrderRequest
	3, // 5: smallbiznis.transaction.v1.TransactionService.CreateOrder:input_type -> smallbiznis.transaction.v1.CreateOrderRequest
	5, // 6: smallbiznis.transaction.v1.TransactionService.UpdateOrder:input_type -> smallbiznis.transaction.v1.Order
	2, // 7: smallbiznis.transaction.v1.TransactionService.ListOrder:output_type -> smallbiznis.transaction.v1.ListOrderResponse
	5, // 8: smallbiznis.transaction.v1.TransactionService.GetOrder:output_type -> smallbiznis.transaction.v1.Order
	5, // 9: smallbiznis.transaction.v1.TransactionService.CreateOrder:output_type -> smallbiznis.transaction.v1.Order
	5, // 10: smallbiznis.transaction.v1.TransactionService.UpdateOrder:output_type -> smallbiznis.transaction.v1.Order
