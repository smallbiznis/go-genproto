...
var (
	filter_InvoiceService_ListInvoiceItems_0 = &utilities.DoubleArray{Encoding: map[string]int{"invoice_id": 0, "invoiceId": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func RegisterInvoiceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InvoiceServiceServer) error {
	...
	mux.Handle("GET", pattern_InvoiceService_ListInvoiceItems_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/smallbiznis.invoice.v1.InvoiceService/ListInvoiceItems", runtime.WithHTTPPathPattern("/v1/invoices/{invoice_id}/invoice_items"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterInvoiceServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InvoiceServiceClient) error {
	...
	mux.Handle("GET", pattern_InvoiceService_ListInvoiceItems_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/smallbiznis.invoice.v1.InvoiceService/ListInvoiceItems", runtime.WithHTTPPathPattern("/v1/invoices/{invoice_id}/invoice_items"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_InvoiceService_ListInvoiceItems_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "invoices", "invoice_id", "invoice_items"}, ""))
)
