...
func request_VoucherService_UpdateVoucher_0(ctx context.Context, marshaler runtime.Marshaler, client VoucherServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateVoucherRequest
	var metadata runtime.ServerMetadata
...
func request_VoucherService_DeleteVoucher_0(ctx context.Context, marshaler runtime.Marshaler, client VoucherServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteVoucherRequest
	var metadata runtime.ServerMetadata
...
func RegisterVoucherServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VoucherServiceServer) error {
	...
	mux.Handle("GET", pattern_VoucherService_GetVoucher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/smallbiznis.voucher.v1.VoucherService/GetVoucher", runtime.WithHTTPPathPattern("/v1/vouchers/{voucher_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_VoucherService_UpdateVoucher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/smallbiznis.voucher.v1.VoucherService/UpdateVoucher", runtime.WithHTTPPathPattern("/v1/vouchers/{voucher_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_VoucherService_DeleteVoucher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/smallbiznis.voucher.v1.VoucherService/DeleteVoucher", runtime.WithHTTPPathPattern("/v1/vouchers/{voucher_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterVoucherServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VoucherServiceClient) error {
	...
	mux.Handle("GET", pattern_VoucherService_GetVoucher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/smallbiznis.voucher.v1.VoucherService/GetVoucher", runtime.WithHTTPPathPattern("/v1/vouchers/{voucher_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_VoucherService_UpdateVoucher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/smallbiznis.voucher.v1.VoucherService/UpdateVoucher", runtime.WithHTTPPathPattern("/v1/vouchers/{voucher_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_VoucherService_DeleteVoucher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/smallbiznis.voucher.v1.VoucherService/DeleteVoucher", runtime.WithHTTPPathPattern("/v1/vouchers/{voucher_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_VoucherService_GetVoucher_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "vouchers", "voucher_id"}, ""))

	pattern_VoucherService_ListVouchers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "vouchers"}, ""))

	pattern_VoucherService_UpdateVoucher_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "vouchers", "voucher_id"}, ""))

	pattern_VoucherService_DeleteVoucher_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "vouchers", "voucher_id"}, ""))
