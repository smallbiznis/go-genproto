...
var file_smallbiznis_storage_v1_storage_resource_proto_goTypes = []interface{}{
...
func file_smallbiznis_storage_v1_storage_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_smallbiznis_storage_v1_storage_resource_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Bucket); i {
			case 0:
				return &v.state
			case 1:
