...
var file_smallbiznis_location_v1_location_resource_proto_goTypes = []interface{}{
...
func file_smallbiznis_location_v1_location_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_smallbiznis_location_v1_location_resource_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smallbiznis_location_v1_location_resource_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*City); i {
			case 0:
				return &v.state
			case 1:
		...
		file_smallbiznis_location_v1_location_resource_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
