...
type RuleServiceClient interface {
	...
	EvaluateRules(ctx context.Context, in *EvaluateRuleRequest, opts ...grpc.CallOption) (*EvaluateRuleResponse, error)
}
...
func (c *ruleServiceClient) EvaluateRules(ctx context.Context, in *EvaluateRuleRequest, opts ...grpc.CallOption) (*EvaluateRuleResponse, error) {
...
type RuleServiceServer interface {
	...
	EvaluateRules(context.Context, *EvaluateRuleRequest) (*EvaluateRuleResponse, error)
...
func (UnimplementedRuleServiceServer) EvaluateRules(context.Context, *EvaluateRuleRequest) (*EvaluateRuleResponse, error) {
...
func _RuleService_EvaluateRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuleServiceServer).EvaluateRules(ctx, req.(*EvaluateRuleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
